...
- [x] **Contact form, server action, and SES** — Add `contact-form.tsx` (client, `useActionState`), `actions/contact.ts` (validate + SES), wired to architecture/SST as in `docs/architecture.md`.
